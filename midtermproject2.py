...
def random():
    ...
    computer_action = random.choice(randombutton)
    print(computer_action)
    randombutton.config(text=computer_action)

b4 = tk.Button(text="Lucky Faculty", font=("Arial", 15 ), bg= "#CAFF70", command=random)
b4.grid(row=2, column=2)
randombutton=tk.Label(bg="#CAFF70", font=("Arial",12 )text="This faculty member gets free parking")
randombutton.grid(row=4,column=4)
